...
// This is now a SERVER component — no "use client", no useEffect, no useState
export default async function DiscoverTours() {
                    ...
                    return (
                        ...
                        >
                            <div className="relative overflow-hidden">
                                <Image
                                    src={tour.images?.[0] || "https://placehold.co/600x400?text=No+Image"}
                                    height={280}
                                    width={400}
                                    alt={tour.title}
