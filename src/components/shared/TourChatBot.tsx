...
//         {
//             role: "assistant",
//             text: "🌿 Hello! I'm your Bangladesh Tour Guide AI. Ask me anything about tours, destinations, travel tips, or how to book!",
//         },
//     ]);
//     const [input, setInput] = useState("");
//     const [loading, setLoading] = useState(false);
...
//                     model: "claude-sonnet-4-20250514",
//                     max_tokens: 1000,
//                     system: `You are a friendly and knowledgeable Bangladesh Tour Guide AI assistant. 
//                     You help users with:
//                     - Information about Bangladesh tourist destinations (Cox's Bazar, Sundarbans, Sajek, Bandarban, Sylhet, etc.)
//                     - Tour packages and pricing guidance
//                     - Travel tips and best times to visit
//                     - Local food, culture, and customs
//                     - How to book tours on this platform
//                     Keep responses concise, helpful, and friendly. Use relevant emojis occasionally.`,
//                     messages: [
//                         ...messages.map((m) => ({
//                             role: m.role,
//                             content: m.text,
...
//             const data = await response.json();
//             const aiText =
//                 data?.content?.[0]?.text || "Sorry, I couldn't understand. Please try again.";
...
//                             </div>
//                             <div>
//                                 <p className="text-white font-bold text-sm">Tour Guide AI</p>
...
//                             className="flex-1 text-sm px-4 py-2.5 rounded-full border border-gray-200 focus:outline-none focus:border-orange-400 bg-gray-50"
//                         />
//                         <button
//                             onClick={sendMessage}
